    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (zodiac == 1)
            {
                ...
                Console.WriteLine("\nLUCKY COLOR: Red");
                Console.WriteLine("LUCKY NUMBER: 9");
            ...
            else if (zodiac == 2)
            {
                ...
                Console.WriteLine("\nLUCKY COLOR: Green");
                Console.WriteLine("LUCKY NUMBER: 6 and 5");
                Console.WriteLine("Sign Compatibility:\n" +
            ...
            else if (zodiac == 3)
            {
                ...
                Console.WriteLine("\nLUCKY COLOR: Yellow ");
                Console.WriteLine("LUCKY NUMBER: 3, 7, and 9 ");
                Console.WriteLine("Sign Compatibility:\n" +
            ...
            else if (zodiac == 7)
            {
                ...
                Console.WriteLine("\nLUCKY COLOR: Pink");
                Console.WriteLine("LUCKY NUMBER: 5, 6, and 9");
                Console.WriteLine("Sign Compatibility:\n" +
            ...
            else if (zodiac == 8)
            {
                ...
                Console.WriteLine("\nLUCKY COLOR: Green");
                Console.WriteLine("LUCKY NUMBER: 8 and 9");
                Console.WriteLine("Sign Compatibility:\n" +
            ...
            else if (zodiac == 9)
            {
                ...
                Console.WriteLine("\nLUCKY COLOR: Blue");
                Console.WriteLine("LUCKY NUMBER: 3, 5, 6, 7, and 8");
                Console.WriteLine("Sign Compatibility:\n" +
            ...
            else if (zodiac == 10)
            {
                ...
                Console.WriteLine("\nLUCKY COLOR: Blue");
                Console.WriteLine("LUCKY NUMBER: 3, 7, 8, and 21");
                Console.WriteLine("Sign Compatibility:\n" +
            ...
            else if (zodiac == 12)
            {
                ...
                Console.WriteLine("\nLUCKY COLOR: Yellow");
                Console.WriteLine("LUCKY NUMBER: 3 and 7");
                Console.WriteLine("Sign Compatibility:\n" +
